...
+ `vancouver_trees`: Were root barriers installed around all the trees planted?

**Final choice**: Out of the four research questions, it seems investigating whether there's a change in the number of storeys built as the years rolled by would be the most interesting to explore.